...
plt.plot(range(1, len(average_mse_val) + 1), average_mse_val, label='Validation MSE')
plt.plot(range(1, len(average_mse_train) + 1), average_mse_train, label='Training MSE')
plt.title("Training vs. Validation MSE - White Wine")
plt.ylabel('MSE')
plt.xlabel('Epochs')
plt.legend()
plt.show()
...
plt.plot(range(1, len(smooth_mse_train) + 1), smooth_mse_train, label='Training MSE')
plt.plot(range(1, len(smooth_mse_val) + 1), smooth_mse_val, label='Validation MSE')
