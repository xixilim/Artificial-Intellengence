...
def origin_model():
    ...
    # The input layer
    model.add(Dense(45, input_dim = 11, activation = 'relu', \
...
plt.title("Training vs. Validation MSE - Red Wine")
plt.ylabel('MSE')
plt.xlabel('Epochs')
plt.legend()
plt.show()
...
plt.title("Training vs. Validation MSE - Red Wine (excluding first 10 points)")
plt.xlabel('Epochs')
plt.ylabel('MSE')
plt.legend()
plt.show()
